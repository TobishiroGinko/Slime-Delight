...
public class GrassBlockCakeBlock extends Block {
    ...
    public GrassBlockCakeBlock(Item pieSlice) {
    ...
    static {
        ...
        SHAPE = new VoxelShape[]{Block.createCuboidShape(1.0, 0.0, 1.0, 15.0, 12.0, 15.0), Block.createCuboidShape(1.0, 0.0, 1.0, 15.0, 12.0, 13.0), Block.createCuboidShape(1.0, 0.0, 1.0, 15.0, 12.0, 11.0), Block.createCuboidShape(1.0, 0.0, 1.0, 15.0, 12.0, 9.0), Block.createCuboidShape(1.0, 0.0, 1.0, 15.0, 12.0, 7.0), Block.createCuboidShape(1.0, 0.0, 1.0, 15.0, 12.0, 5.0), Block.createCuboidShape(1.0, 0.0, 1.0, 15.0, 12.0, 3.0)};
    }
}